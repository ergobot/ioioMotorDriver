...
Description: The application demo the use of a ioio mint (Droidalyzer) and a Motor Driver 1A Dual TB6612FNG.  The other purpose of the application is to make a simple to use library for the motor driver. 
